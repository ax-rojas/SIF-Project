...
public class SIF_Attr {
     ...
     */
    public void setSec3(Sec3_Attr[] sec3) {
        this.sec3 = sec3;
    }
     ...
     */
    public void setSec4(Sec4_Attr[] sec4) {
        this.sec4 = sec4;
    }
    ...
    private Sec3_Attr[] sec3;
    private Sec4_Attr[] sec4; 
    private OPT_Attr opt;
    private OTL_Attr otl;
    
    public SIF_Attr() {
    }
    public SIF_Attr(Sec1_Attr sec1,Sec2_Attr sec2,Sec3_Attr[] sec3,Sec4_Attr[] sec4) {
        this.sec1 = sec1;
        this.sec2 = sec2;
        this.sec3 = sec3;
        this.sec4 = sec4;
    ...
    public SIF_Attr(Sec1_Attr sec1,Sec2_Attr sec2,Sec3_Attr[] sec3,Sec4_Attr[] sec4,OPT_Attr opt,OTL_Attr otl) {
        this.sec1 = sec1;
        this.sec2 = sec2;
        this.sec3 = sec3;
        this.sec4 = sec4;
